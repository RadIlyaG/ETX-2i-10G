...
proc DeleteOldApp {} {
  ...
  foreach fol [glob -nocomplain -type d c:/download/sw/*] {
    ...
    if {[string match -nocase {6.8.2(0.75)} [file tail $fol]]} {
      catch {file delete -force $fol}
    }
    if {[string match -nocase {6.8.2(0.59)} [file tail $fol]]} {
      catch {file delete -force $fol}
    }
    ...
    if {[string match -nocase {6.8.5(3.31)_ATT} [file tail $fol]]} {
      catch {file delete -force $fol}
    }
    if {[string match -nocase {6.8.4(2.33)_ATT} [file tail $fol]]} {
      catch {file delete -force $fol}
    }
    
    if {[string match -nocase {6.7.1(0.127)_SFR} [file tail $fol]]} {
      catch {file delete -force $fol}
    }
    
    if {[string match -nocase {6.7.1(0.131)_cov} [file tail $fol]]} {
      catch {file delete -force $fol}
    }
    
    if {[string match -nocase {6.8.2(0.75)_EIR} [file tail $fol]]} {
      catch {file delete -force $fol}
    }
    
    if {[string match -nocase {6.8.5(0.181)_COV} [file tail $fol]]} {
      catch {file delete -force $fol}
    }
    
    if {[string match -nocase {6.8.2(0.85)_FTR} [file tail $fol]]} {
      catch {file delete -force $fol}
    }
    
    if {[string match -nocase {6.8.5(1.44)} [file tail $fol]]} {
      catch {file delete -force $fol}
    }
    
    if {[string match -nocase {6.8.2(0.75)_LY} [file tail $fol]]} {
      catch {file delete -force $fol}
    }
    
    if {[string match -nocase {6.8.5(1.62)} [file tail $fol]]} {
      catch {file delete -force $fol}
    }
