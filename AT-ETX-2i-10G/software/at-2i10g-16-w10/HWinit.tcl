...
switch -exact -- $gaSet(pair) {
  1 - 5 - SE {
      ...
      set gaSet(pioBoxSerNum) FT6Z7Z94  
  }
  2 {
      set gaSet(comDut)      2; #5
  ...
  3 {
      set gaSet(comDut)     9 ; #7
      set gaSet(com220)     6; #3 ; #8
      set gaSet(comAux1)   NA
      set gaSet(comAux2)   NA
      set gaSet(comGpib)   NA
      console eval {wm geometry . +150+200}
  ...
  4 {
      set gaSet(comDut)    10 ; # 9
      set gaSet(com220)    8 ; # 10
      set gaSet(comAux1)   NA
      set gaSet(comAux2)   NA
      set gaSet(comGpib)   NA
      console eval {wm geometry . +150+200}
