...
switch -exact -- $gaSet(pair) {
  1 - 5 - SE {
      set gaSet(comDut)     5; #2
      set gaSet(com220)     4; #4
      set gaSet(comAux1)    2; #5
      set gaSet(comAux2)    6; #6
      set gaSet(comGpib)   13
      console eval {wm geometry . +150+1}
      console eval {wm title . "Con 1"} 
      set gaSet(pioBoxSerNum) FT567XU9  
  }
  2 {
      set gaSet(comDut)      8; #8
      set gaSet(com220)      9; #9
      ...
      set gaSet(pioBoxSerNum) FT5PHYXL         
  }
