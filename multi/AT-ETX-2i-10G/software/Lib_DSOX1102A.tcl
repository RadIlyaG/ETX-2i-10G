...
#   set visaAddr "USB0::10893::6023::CN57344642::INSTR"
#   set visaAddr "USB0::10893::6023::CN56404126::INSTR"
  foreach DSOX1102ASerNumber [list CN58064160 CN57344642 CN56404126 CN58064279 \
      CN56404116 CN58174246 CN59014296] {
  ...
  if {$::DsScope=="A"} {
    for {set try 1} {$try <= 3} {incr try} {
      ...
      foreach ch {1 2} {
        ...
        puts "[MyTime] try:$try ch-$ch delta:  $delta nSec"
        if {$delta>100} {
