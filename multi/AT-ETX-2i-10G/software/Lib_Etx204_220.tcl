proc Etx220Config {port lineRate} {
  ...
  set size 128 ; # 1000 ; # 
  puts "RL10GbGen::Config $gaSet(id220) $port $port -sizeType Fixed -size $size -dataPatternType Random -lineRate $lineRate .. [MyTime]"
  update
  RL10GbGen::Config $gaSet(id220) $port $port -sizeType Fixed -size $size -dataPatternType Random -lineRate $lineRate 
}
# ***************************************************************************
# Etx220Start
# ***************************************************************************
